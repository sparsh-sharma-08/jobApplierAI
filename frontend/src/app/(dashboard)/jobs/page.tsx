...
const sourceColors: Record<string, string> = {
    ...
    findremotely: 'bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400',
    ...
    instahyre: 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400',
    weworkremotely: 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400',
};
                ...
                <div className="flex gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative">
                            ...
                            />
                            <Link className="w-4 h-4 absolute left-3 top-3 text-slate-400 dark:text-slate-500" />
                        </div>
                            ...
                            >
                                <div className="p-5 flex gap-4">
                                    ...
                                    {settings.showScoreBadges && (
                                        <div className={`w-14 h-14 rounded-2xl border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 flex items-center justify-center flex-shrink-0 overflow-hidden`}>
                                            <span className="text-slate-900 dark:text-white font-black text-lg">{Math.round(score)}</span>
                                        </div>
                                    )}
                                ...
                                {/* Expanded View */}
                                {isExpanded && (
                                    <div className="px-5 pb-5 pt-2 border-t border-slate-100 dark:border-slate-800 space-y-4 animate-in fade-in slide-in-from-top-2 duration-300" onClick={(e) => e.stopPropagation()}>
                                        {/* Missing Skills */}
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-1.5">
                                                    {missingSkills.map((skill, i) => (
                                                        <span key={i} className="inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-md border border-red-100 dark:border-red-900/30">
                                        ...
                                        {/* AI Features Section */}
                                        <div className="pt-3 border-t border-slate-100 dark:border-slate-800 space-y-3 mt-3">
                                            ...
                                            {interviewError && <div className="text-sm text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 p-2 rounded border border-red-100 dark:border-red-900/30">{interviewError}</div>}
                                            {coldEmailError && <div className="text-sm text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 p-2 rounded border border-red-100 dark:border-red-900/30">{coldEmailError}</div>}
